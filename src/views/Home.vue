...
//    const {ChartData} = await proxy.$api.getChartData()
//    xOptions.xAxis.data = ChartData.date
//    xOptions.series = Object.keys(ChartData.data[0]).map(val=>({
//       name:val,
//       data:ChartData.data.map(item=>item[val]),
//       type: "line"
//    }))
...
//请求图表数据并渲染的方法
const getChartData = async () => {
    const {ChartData,userData,videoData} = await proxy.$api.getChartData()
        ...
        <el-col :span="8" style="margin-top: 20px;">
            <el-card shadow="hover">
                <div class="user">
                    ...
                    <div class="user-info">
                        <p class="user-info-p">欢迎您，</p>
                        <p class="user-info-admin">管理员</p>
                    </div>
                </div>
                <div class="login-info">
                    <p>您上次登录时间：<span>2023-03-15 15:25:30</span></p>
                    <p>您上次登录IP：<span>127.0.0.1</span></p>
                </div>
            </el-card>

            <el-card shadow="hover" class="use-table">
